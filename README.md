...
import all four difficulties at once.
...
Two extra `apply_style.py` flags tune *how* it restyles, independent of
timing/object count/type, which are never touched either way:
